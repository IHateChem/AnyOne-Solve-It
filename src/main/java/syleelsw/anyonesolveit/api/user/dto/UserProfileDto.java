...
public class UserProfileDto {
    ...
    @Builder
    private UserProfileDto(Long id, String username,String city, String email, String bjname, String prefer_type, Locations area, LanguageTypes language, boolean isFirst) {
        this.id = id;
